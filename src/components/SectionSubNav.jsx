    ...
    <div className="px-4">
      ...
      {sections.map((section, i) => (
        <button
          ...
          className={`flex-shrink-0 flex items-center gap-1.5 px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-full text-[9px] sm:text-[10px] font-bold tracking-widest uppercase transition-colors ${
            sectionIdx === i
