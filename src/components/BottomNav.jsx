      ...
      <div className="flex items-center gap-2 min-w-max sm:min-w-0 sm:w-full sm:justify-between lg:w-full lg:justify-between">
        {TABS.map((tab) => (
          <button
            ...
            className={`flex-shrink-0 lg:flex-1 text-center py-5 px-3 lg:px-3 rounded-lg text-[10px] lg:text-base font-normal leading-4 tracking-normal transition-all duration-150 whitespace-nowrap ${
              activeTab === tab
