          ...
          return (
            <div key={tab} className="relative flex-shrink-0 lg:flex-1 flex">
              <button
                ...
                className={`w-full text-center py-5 px-3 lg:px-3 rounded-lg text-[10px] lg:text-base font-normal leading-4 tracking-normal transition-all duration-150 whitespace-nowrap ${
                  activeTab === tab
